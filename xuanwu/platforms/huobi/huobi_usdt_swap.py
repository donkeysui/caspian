...
from xuanwu.const import HUOBI_USDT_SWAP, USER_AGENT
...
class HuobiUsdtSwapRestAPI:
    ...
    async def get_account_position(self, contract_code):
        ...
        Attributes:
            :param contract_code: Currency name, e.g. BTC-USDT.
    ...
    async def get_history_orders(self, contract_code, trade_type, stype, status, create_date, page_index=0,
                                 page_size=50):
        ...
        Attributes:
            ...
            :param trade_type:  0:all,
                                ...
                                5: sell liquidation,
                                6: buy liquidation,
                                7:Delivery long,8: Delivery short
            :param stype: 1:All Orders,
...
class HuobiUsdtSwapTrade(Websocket):
    ...
    def __init__(self, **kwargs):
        ...
        self._position = Position(self._platform, self._account, self._strategy,
    ...
    async def create_order(self, action, price, quantity, order_type=ORDER_TYPE_LIMIT, client_order_id=None,
                           **kwargs):
        """ Create an order.
        Attributes:
        ...
        result, error = await self._rest_api.create_order(self._symbol, price, quantity, direction, offset, lever_rate,
    ...
    async def revoke_order(self, *order_nos):
        """ Revoke (an) order(s).
        Attributes:
            :param order_nos: Order id list,
                              you can set this param to 0 or multiple items. If you set 0 param, you can cancel
                              all orders for this symbol(initialized in Trade object). If you set 1 param, you can
                              cancel an order. If you set multiple param, you can cancel multiple orders.
                              Do not set param length more than 100.
        :returns:
            :return Success or error, see bellow.
        """
        if len(order_nos) == 0:
